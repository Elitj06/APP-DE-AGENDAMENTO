...
const PRICING = [
  { name: "Starter", price: "R$ 97", period: "/mês", features: ["Até 30 alunos", "Agendamento básico", "Check-in manual", "1 trainer", "WhatsApp (100 msg/mês)"], cta: "Começar grátis", popular: false },
  { name: "Pro", price: "R$ 197", period: "/mês", features: ["Até 150 alunos", "Agendamento completo", "Check-in facial + catraca", "5 trainers", "WhatsApp ilimitado", "GymCoins + Rankings", "TV Display"], cta: "Teste 14 dias grátis", popular: true },
  { name: "Enterprise", price: "R$ 397", period: "/mês", features: ["Alunos ilimitados", "Multi-unidade", "API completa", "Integrações Wellhub/TotalPass", "Suporte prioritário", "White-label", "Analytics avançado"], cta: "Falar com vendas", popular: false },
];
